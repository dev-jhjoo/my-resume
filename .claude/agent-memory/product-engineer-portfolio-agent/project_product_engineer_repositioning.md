...
**추가 개선 완료 (2026-07-22)**
- `#resume` 탭 경력 불릿 전면 정리: 커넥틴(3개), 카닥(1개), 에이피엠멤버스(2개), 에어프레미아(3→1개 통합), 케이피모바일(nested→flat 4개) — 기술/태스크 나열에서 문제→행동→임팩트 서술로.
- 기술과 실행 범위(skill panels) 주석 해제해 화면에 활성화. 내용은 기존 역량 그룹핑 유지, 문구 소폭 다듬기.
